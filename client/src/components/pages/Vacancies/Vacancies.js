...
export class Vacancies extends Component {
  ...
  generateVacancyMessage = () => {
    let message = ''
    const vacancies = this.chooseVacancies()
    let lastDigit = vacancies.length % 10
    switch (lastDigit) {
      case 1:
        message = `Знайдено ${vacancies.length} вакансію`;
        break;
      case 2:
      case 3:
      case 4:
        message = `Знайдено ${vacancies.length} вакансії`;
        break;
      default:
        message = `Знайдено ${vacancies.length} вакансій`;
    }
    return message;
  }
        ...
        <Container maxWidth="lg">
          <div className="vacancies">
            ...
            <div className="main">
              ...
              <VacancyList 
                vacancies={this.chooseVacancies()} 
                className="list"
              />
            </div>
          </div>
