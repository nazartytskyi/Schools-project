          ...
          <Card className="about-card">
            <CardContent>
              <div className="about-header">
                <Typography variant="h5">Про S_cool_S</Typography>
              </div>
              <Typography className="about-text">
                Платформа <b><em>S_cool_S</em></b> створена для учнів установ середньої освіти, а також для 
                ...
                шкіл, розташування на карті та віддаленість школи від Вашого дому а також почитати відгуки про школу
                або останні новини.
              </Typography>
              <div className="about-header">
              ...
              <Typography className="about-text">
                <b><em>S_cool_S </em></b> надає інформацію про рейтинг шкіл на основі середнього балу всіх
              ...
              <Typography className="about-text">
                ...
                а також порядковий номер учня в черзі. <b><em>S_cool_S </em></b> надає можливість подавати заяву та
              ...
              <Typography className="about-text">
                ...
                шукати школу яка найбільш підходить Вам по тим чи іншим показникам. Зокрема <b><em>S_cool_S </em></b>
              ...
              <Typography className="about-text">
                ...
                резюме на вибрану вакансію. На <b><em>S_cool_S </em></b>Ви зможете дізнатися про <Link to="/news" 
